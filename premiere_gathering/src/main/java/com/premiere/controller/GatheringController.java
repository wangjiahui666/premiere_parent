...
import com.premiere.service.GatheringService;
...
public class GatheringController extends ExceptionController{
    ...
    @RequestMapping(value = "/city/{city}/{page}/{size}", method = RequestMethod.GET)
    public Result findByCitySearch(@PathVariable Integer page,
                                   @PathVariable Integer size,
                                   @PathVariable String city) {
        Page<Gathering> info = gatheringService.findByCitySearch(city, page, size);
        return new Result(true, StatusCode.OK, "查询成功", new PageResult<>(info.getTotalElements(), info.getContent()));
    }
}
