...
import com.premiere.mapper.GatheringMapper;
...
import com.premiere.dao.GatheringDao;
...
public class GatheringService {
    ...
    @Autowired
    public GatheringService(GatheringDao gatheringDao, IdWorker idWorker, GatheringMapper gatheringMapper) {
    ...
    public Page<Gathering> findSearch(Map whereMap, int page, int size) {
        ...
        return gatheringDao.findAll(this.createSpecification(whereMap), pageRequest);
    }
    ...
    public List<Gathering> findSearch(Map whereMap) {
        return gatheringDao.findAll(this.createSpecification(whereMap));
    }
    ...
    public Gathering findById(String id) {
        return gatheringDao.findOneById(id);
    }
    ...
    @Cacheable(value = "Gathering", key = "#city")
    public Page<Gathering> findByCitySearch(String city, Integer page, Integer size) {
        PageRequest pageRequest = PageRequest.of(page, size);
        return gatheringDao.findAllByCity(city, pageRequest);
    }
}
